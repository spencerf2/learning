...
// 1. Why use slog.ErrorContext() instead of just fmt.Printf() for errors?
//   - 
//
// 2. How does context help with error logging and tracing?
//   - 
//
// 3. When should you log an error vs just return it?
//   - 
