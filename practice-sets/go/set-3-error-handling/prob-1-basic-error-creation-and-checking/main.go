...
// 1. When should you use errors.New() vs fmt.Errorf()?
//   - 
//
// 2. Why does Go use explicit error returns instead of exceptions?
//   - 
//
// 3. What's the difference between %v and %s when printing errors?
//   - 
